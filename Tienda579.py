...
IpCaja = config['TiendaFTP579']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP579'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP579'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP579']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP579']["RutaNAS"]
