...
IpCaja = config['TiendaFTP153']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP153'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP153'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP153']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP153']["RutaNAS"]
