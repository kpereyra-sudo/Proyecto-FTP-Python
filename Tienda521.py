...
IpCaja = config['TiendaFTP521']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP521'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP521'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP521']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP521']["RutaNAS"]
