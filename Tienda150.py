...
IpCaja = config['TiendaFTP150']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP150'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP150'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP150']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP150']["RutaNAS"]
