...
IpCaja = config['TiendaFTP711']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP711'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP711'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP711']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP711']["RutaNAS"]
