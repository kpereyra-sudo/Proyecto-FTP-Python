...
IpCaja = config['TiendaFTP152']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP152'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP152'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP152']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP152']["RutaNAS"]
