...
IpCaja = config['TiendaFTP587']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP587'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP587'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP587']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP587']["RutaNAS"]
