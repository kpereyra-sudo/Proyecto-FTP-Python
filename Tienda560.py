...
IpCaja = config['TiendaFTP560']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP560'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP560'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP560']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP560']["RutaNAS"]
