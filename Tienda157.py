...
IpCaja = config['TiendaFTP157']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP157'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP157'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP157']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP157']["RutaNAS"]
