...
IpCaja = config['TiendaFTP573']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP573'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP573'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP573']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP573']["RutaNAS"]
