...
IpCaja = config['TiendaFTP508']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP508'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP508'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP508']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP508']["RutaNAS"]
