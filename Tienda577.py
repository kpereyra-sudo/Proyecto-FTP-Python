...
IpCaja = config['TiendaFTP577']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP577'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP577'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP577']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP577']["RutaNAS"]
