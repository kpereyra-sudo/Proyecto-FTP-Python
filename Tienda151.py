...
IpCaja = config['TiendaFTP151']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP151'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP151'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP151']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP151']["RutaNAS"]
