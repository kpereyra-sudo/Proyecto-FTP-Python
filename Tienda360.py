...
IpCaja = config['TiendaFTP516']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP516'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP516'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP516']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP516']["RutaNAS"]
