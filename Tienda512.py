...
def InsertarRutaFTP(journal):
    ...
    # # Ir al directorio especificado
        ftp.cwd('/journal/Journal Generales/512')
    # #acceder a los archivos del directorio
    ...
    #         ftp.storbinary("STOR"  + journal, file)
        ...
        local_filename = "//10.10.1.67/Volume_1/Journal y Lventas/Journal/2020/512 Leopoldo/%s" %journal
...
for journal in lista_journal:
    ...
    if len(journal) == 7 :
        #insert NAS
        insertar_ruta_nas(r"\\10.10.1.67\Volume_1\Journal y Lventas\Journal\2020\512 Leopoldo")
        #Insert on My desk
