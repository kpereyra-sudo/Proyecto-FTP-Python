...
IpCaja = config['TiendaFTP581']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP581'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP581'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP581']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP581']["RutaNAS"]
