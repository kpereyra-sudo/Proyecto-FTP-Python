...
IpCaja = config['TiendaFTP586']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP586'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP586'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP586']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP586']["RutaNAS"]
