...
IpCaja = config['TiendaFTP576']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP576'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP576'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP576']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP576']["RutaNAS"]
