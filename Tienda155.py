...
IpCaja = config['TiendaFTP155']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP155'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP155'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP155']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP155']["RutaNAS"]
