...
IpCaja = config['TiendaFTP523']['ipcaja']
# leer ruta nas y la concatena con cada journal subido.
NasPATHFile = config['TiendaFTP523'][ "pathfile"]
#Lee el servidor especificado en este caso el milady del FTP
ServiDORMilady = config['TiendaFTP523'][ "Servidor"]
# Lee la ruta FTP hacia donde dirigira los Journal
RutaFTP = config['TiendaFTP523']["RutaFTP"]
#Lee ruta NAS
RutaNAS = config['TiendaFTP523']["RutaNAS"]
